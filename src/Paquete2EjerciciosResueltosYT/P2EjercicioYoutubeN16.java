...
public class P2EjercicioYoutubeN16 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("INGRESE EL NUMERO DE CUANTOS CLIENTES REALIZARA EL PRESTAMO");
        numero_clientes = sc.nextInt();
        
        for (int i = 1; i < numero_clientes+1; i++) {
            ...
            do{
                ...
                System.out.println("SE ACABO EL SALDO YA NO PUEDE SEGUIR REALIZANDO MAS PRESTAMOS DE DINERO");
        }
    }
